...
class CustomButtonBlock(val ticks: Int): AbstractButtonBlock(false, FabricBlockSettings.of(Material.SUPPORTED).noCollision().strength(0.5f, 0.1f).breakByHand(true)) {
