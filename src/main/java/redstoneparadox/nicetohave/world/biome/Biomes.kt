...
object Biomes {
    ...
    fun registerBiomes() {
        if (Config.World.goldInRivers) {
            BAD_LANDS_RIVER.addFeature(GenerationStep.Feature.TOP_LAYER_MODIFICATION, Features.GOLD_RIVER_ORE.configure(FeatureConfig.DEFAULT).createDecoratedFeature(Decorators.SURFACE.configure(DecoratorConfig.DEFAULT)))
            ...
            VanillaBiomes.FROZEN_RIVER.addFeature(GenerationStep.Feature.TOP_LAYER_MODIFICATION, Features.GOLD_RIVER_ORE.configure(FeatureConfig.DEFAULT).createDecoratedFeature(Decorators.SURFACE.configure(DecoratorConfig.DEFAULT)))
        }
    }
