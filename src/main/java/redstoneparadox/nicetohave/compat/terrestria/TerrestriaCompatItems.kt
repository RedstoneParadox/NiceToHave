...
object TerrestriaCompatItems : ItemsInitializer() {
    ...
    val STRIPPED_REDWOOD_POLE : BlockItem? = registerPoleItem(TerrestriaCompatBlocks.REDWOOD_POLE, "stripped_redwood")
    val STRIPPED_HEMLOCK_POLE : BlockItem? = registerPoleItem(TerrestriaCompatBlocks.HEMLOCK_POLE, "stripped_hemlock")
    val STRIPPED_RUBBER_WOOD_POLE : BlockItem? = registerPoleItem(TerrestriaCompatBlocks.RUBBER_WOOD_POLE, "stripped_rubber")
    val STRIPPED_CYPRESS_POLE : BlockItem? = registerPoleItem(TerrestriaCompatBlocks.CYPRESS_POLE, "stripped_cypress")
    val STRIPPED_WILLOW_POLE : BlockItem? = registerPoleItem(TerrestriaCompatBlocks.WILLOW_POLE, "stripped_willow")
    val STRIPPED_JAPANESE_MAPLE_POLE : BlockItem? = registerPoleItem(TerrestriaCompatBlocks.JAPANESE_MAPLE_POLE, "stripped_japanese_maple")
    val STRIPPED_RAINBOW_EUCALYPTUS_POLE : BlockItem? = registerPoleItem(TerrestriaCompatBlocks.RAINBOW_EUCALYPTUS_POLE, "stripped_rainbow_eucalyptus")
    val STRIPPED_SAKURA_POLE : BlockItem? = registerPoleItem(TerrestriaCompatBlocks.SAKURA_POLE, "stripped_sakura")
