...
class NewRangeConfigOption(value : Double, val min : Double, val max : Double, key: String, comment: String, parentCategory: NewConfigCategory) : NewConfigOption<Double>(Double::class.javaObjectType, value, key, comment, parentCategory) {
