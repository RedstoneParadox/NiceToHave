...
object NewConfig : NewConfigCategory() {
    ...
    object Items : NewConfigCategory("items", "Various Items", getSelf()) {
    ...
    object Blocks : NewConfigCategory("blocks", "Various blocks.", getSelf()) {
    ...
    object Recipes : NewConfigCategory("recipes", "New recipes and tweaks to existing ones.", getSelf()) {
    ...
    object Potions : NewConfigCategory("potions", "Potions", getSelf()) {
    ...
    object World : NewConfigCategory("world", "Various world features", getSelf()) {
    ...
    object Misc : NewConfigCategory("misc", "Enable/Disable items.", getSelf()) {
